...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Host.large_image'
        db.alter_column('hosting_host', 'large_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Host.large_image'
        db.alter_column('hosting_host', 'large_image', self.gf('django.db.models.fields.files.ImageField')(default=1, max_length=100))
